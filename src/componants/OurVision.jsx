...
const OurVision = () => {
  return (
    <div className='mb-[617px]'>
        <h1 className='our-vision-title text-[28px] px-8 md:text-[48px] text-center mb-[329px]'>Our vision revolves around three core <span className='text-[#76E494]'>principles</span></h1>
